...
namespace ESL_System.Form
{
    public partial class ScoreMappingTable : FISCA.Presentation.Controls.BaseForm
    {
        ...
        private void ScoreMappingTable_Load(object sender, EventArgs e)
        {
            ...
            ConfigData cd = School.Configuration["ESL等第對照表"];
            ...
            {                
                ...
                row.CreateCells(dgv,EngName, score);
                dgv.Rows.Add(row);
        ...
        {
            return XmlHelper.LoadXml(Properties.Resources.預設ESL等第對照表).OuterXml;
        }
        ...
        public static void CheckDefault()
        {
            ...
            if (string.IsNullOrEmpty(cd["xml"]))
            {
                cd["xml"] = XmlHelper.LoadXml(Properties.Resources.預設ESL等第對照表).OuterXml;
                cd.Save();
            }
        }
        ...
        private bool ValidateAll()
        {
            ...
            foreach (DataGridViewRow row in dgv.Rows)
            {
                ...
                string code = "" + row.Cells[chEngName.Index].Value;
        ...
        private bool ValidateRow(DataGridViewRow row)
        {
            ...
            if (string.IsNullOrEmpty("" + row.Cells[chEngName.Index].Value))
            {                
        ...
        {
            if (e.ColumnIndex != chEngName.Index && e.ColumnIndex != chScore.Index) return;
